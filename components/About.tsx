...
function StatusBar({ activeTab, active }: { activeTab: Tab; active: string }) {
  return (
    <div
    ...
    >
      ...
      <div className="flex items-center gap-3">
        <span className="text-[11px]" style={{ color: activeTab.color, opacity: 0.7 }}>
          {LANG_LABEL[active]}
        </span>
...
export default function About() {
  ...
  return (
    <section id="about" className="min-h-screen pb-24 pt-24 overflow-x-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-5">
        ...
        >
          ...
          <div className="overflow-x-auto py-5 px-3">
          ...
          <StatusBar activeTab={activeTab} active={active} />
        </div>
